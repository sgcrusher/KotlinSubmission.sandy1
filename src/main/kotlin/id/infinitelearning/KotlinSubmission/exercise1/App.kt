...
fun myProfile() {
    ...
    val NamaDep : String = "Sandy"
    val NamaBel : String = "Gustyanto"
    val umur : Int = 20
    val stat : Boolean = false

    println("Nama Depan saya adalah $NamaDep")
    println("Nama Belakang saya adalah $NamaBel")
    println("Umur saya adalah $umur")
    println("Status saya apakah single?  $stat")
 ...
 */
fun myName(): String {
    val group3 = listOf("Sandy", "Andika", "Thariqi", "Yuris", "Luciana")
    println(group3.get(0))
...
fun totalMember(): Int {
    ...
    val countOfGroup = 5
    val jumlahmentor = mentor.count()
    val total = countOfGroup + jumlahmentor
...
fun main() {
     ...
     *
     */
    groupDetail(3, listOf("Sandy", "Andika", "Thariqi", "Yuris", "Luciana"), "afternoon")
